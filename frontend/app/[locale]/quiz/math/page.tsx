...
//               const percentage = scoreData.total > 0 ? Math.round(scoreData.score ) : 0;
//               return (
...
//                 className={`gradient-btn-green w-full text-black font-semibold py-3 px-6 rounded-xl text-lg disabled:bg-gray-400 disabled:opacity-70 disabled:cursor-not-allowed relative ${
